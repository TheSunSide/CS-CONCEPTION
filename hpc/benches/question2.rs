...
use hpc::questions::question2::{multi_threaded_computation_solution, single_threaded_computation};
...
pub fn bench(c: &mut Criterion) {
    ...
    group.bench_function("question 2 multi-thread", |b| {
        b.iter(|| multi_threaded_computation_solution(black_box(&to_compute)))
    });
    group.finish();
}
